...
{
  return gen_binary(ID_and, bool_typet(), op1, op2);
}
...
{
  return gen_binary(ID_or, bool_typet(), op1, op2);
}
...
{
  return gen_binary(ID_implies, bool_typet(), op1, op2);
}
...
{
  exprt tmp(ID_address_of, gen_pointer_type(op.type()));
