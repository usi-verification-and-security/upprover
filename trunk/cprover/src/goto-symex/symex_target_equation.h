...
public:
  ...
  ///each item of SSA_stepst are equalities between exprt expressions.
  ///This list is constructed incrementally as the symbolic execution engine
  ///walks through the goto-program using the symex_targett interface.
