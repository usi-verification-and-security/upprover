...
{
  std::cout <<"\n"
    "UpProver [version " << UPPROVER_VERSION << " uses CPROVER " << CPROVER_VERSION_UPPROVER << "]"
    "\n"
    "Usage:                         Purpose:\n"
    "\n"
    " upprover [-?] [-h] [--help]   print this help\n"
    " upprover [options] <file>     run upprover on C `file'\n"
    "\nUpProver options for incremental verification of program revisions:\n"
    "--bootstrapping <file1>        run upprover on the first program version 'file1'\n"
    "--summary-validation <file2>   run incremental check on the second\n"
    "                               changed version 'file2'\n"
