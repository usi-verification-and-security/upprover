...
//assert(action == fixed_request_queue[3].__ddv_queue_alive);
//assert(action == fixed_request_queue[6].backing_dev_info.ra_pages);
//assert(action == fixed_request_queue[8].unplug_fn);
//assert(action == fixed_request_queue[3].request_fn);
//assert(action == fixed_request_queue[7].__ddv_genhd_no);
assert(_ddv_module_license != _ddv_module_param_nowayout);
//assert(action == fixed_request_queue[1].backing_dev_info.ra_pages);
//assert(__cil_tmp2 == fixed_request_queue[2].queue_lock);
//assert(action == fixed_request_queue[4].hardsect_size);
assert(_ddv_module_description != _ddv_module_param_action);
//assert(action == fixed_request_queue[5].backing_dev_info.capabilities);
//assert(action == fixed_request_queue[6].hardsect_size);
//assert(action == fixed_request_queue[0].backing_dev_info.ra_pages);
assert(action == 0);
//assert(action == fixed_request_queue[4].backing_dev_info.ra_pages);
//assert(action == fixed_request_queue[5].backing_dev_info.ra_pages);
//assert(__cil_tmp2 == fixed_request_queue[4].queuedata);
//assert(__cil_tmp2 == fixed_request_queue[9].queuedata);
assert(_ddv_module_author <= _ddv_module_param_nowayout);
assert(action == ddv_ioport_request_len);
//assert(action == fixed_request_queue[6].queue_flags);
//assert(action == fixed_request_queue[8].backing_dev_info.ra_pages);
//assert(action == fixed_request_queue[4].request_fn);
//assert(action == fixed_request_queue[2].queue_flags);
//assert(action == fixed_request_queue[8].request_fn);
//assert(__cil_tmp2 == fixed_request_queue[3].queuedata);
//assert(action == fixed_request_queue[5].request_fn);
//assert(action == fixed_request_queue[1].request_fn);
//assert(action == fixed_request_queue[6].__ddv_queue_alive);
assert(action == number_request_queue_used);
//assert(action == fixed_request_queue[9].queue_flags);
//assert(action == fixed_request_queue[3].__ddv_genhd_no);
assert(_ddv_module_description <= _ddv_module_param_action);
//assert(action == fixed_request_queue[3].queue_flags);
//assert(action == fixed_request_queue[1].unplug_fn);
//assert(__cil_tmp2 == fixed_request_queue[6].queue_lock);
assert(_ddv_module_author != _ddv_module_description);
assert(zf_action == 2048);
//assert(action == fixed_request_queue[3].unplug_fn);
assert(action == fixed_cdev_used);
assert(action == zf_port_lock.init);
//assert(action == fixed_request_queue[8].backing_dev_info.state);
//assert(action == fixed_request_queue[8].make_request_fn);
//assert(__cil_tmp2 == fixed_request_queue[3].queue_lock);
//assert(action == fixed_request_queue[2].request_fn);
//assert(action == fixed_request_queue[4].queue_flags);
//assert(__cil_tmp2 == fixed_request_queue[0].queuedata);
//assert(action == fixed_request_queue[2].hardsect_size);
//assert(action == fixed_request_queue[4].backing_dev_info.capabilities);
//assert(action == fixed_request_queue[6].unplug_fn);
assert(_ddv_module_license <= _ddv_module_param_action);
assert(action == zf_port_lock.locked);
//assert(action == fixed_request_queue[9].backing_dev_info.state);
//assert(action == fixed_request_queue[8].backing_dev_info.capabilities);
//assert(action == fixed_request_queue[9].backing_dev_info.ra_pages);
//assert(action == fixed_request_queue[3].backing_dev_info.capabilities);
//assert(action == fixed_request_queue[4].__ddv_queue_alive);
//assert(action == fixed_request_queue[0].make_request_fn);
//assert(action == fixed_request_queue[3].hardsect_size);
//assert(__cil_tmp2 == fixed_request_queue[0].queue_lock);
//assert(action == fixed_request_queue[1].queue_flags);
//assert(__cil_tmp2 == fixed_request_queue[8].queue_lock);
assert(action == ddv_ioport_request_start);
//assert(action == fixed_request_queue[2].make_request_fn);
//assert(__cil_tmp2 == fixed_request_queue[2].queuedata);
//assert(action == fixed_request_queue[1].make_request_fn);
//assert(action == fixed_request_queue[7].backing_dev_info.state);
//assert(action == fixed_request_queue[6].backing_dev_info.state);
assert(_ddv_module_param_action >= _ddv_module_param_nowayout);
//assert(action == fixed_request_queue[7].unplug_fn);
//assert(action == fixed_request_queue[5].backing_dev_info.state);
//assert(action == fixed_request_queue[1].backing_dev_info.state);
//assert(action == fixed_request_queue[7].make_request_fn);
//assert(action == fixed_request_queue[6].request_fn);
assert(_ddv_module_author <= _ddv_module_license);
//assert(action == fixed_request_queue[5].__ddv_genhd_no);
assert(_ddv_module_license != _ddv_module_param_action);
//assert(action == fixed_request_queue[2].unplug_fn);
//assert(action == fixed_request_queue[0].request_fn);
//assert(action == fixed_request_queue[3].backing_dev_info.ra_pages);
//assert(__cil_tmp2 == fixed_request_queue[6].queuedata);
assert(_ddv_module_author != _ddv_module_license);
assert(current_execution_context == kernel_lock.init);
//assert(action == fixed_request_queue[2].backing_dev_info.state);
//assert(action == fixed_request_queue[4].make_request_fn);
assert(action == zf_lock.locked);
//assert(action == fixed_request_queue[9].make_request_fn);
//assert(action == fixed_request_queue[9].__ddv_queue_alive);
//assert(action == fixed_request_queue[7].request_fn);
//assert(__cil_tmp2 == fixed_request_queue[5].queue_lock);
//assert(action == fixed_request_queue[9].request_fn);
//assert(action == fixed_request_queue[8].__ddv_queue_alive);
//assert(action == fixed_request_queue[4].backing_dev_info.state);
//assert(action == fixed_request_queue[2].backing_dev_info.ra_pages);
assert(action == zf_lock.init);
//assert(action == fixed_request_queue[0].hardsect_size);
//assert(action == fixed_request_queue[6].make_request_fn);
//assert(action == fixed_request_queue[6].__ddv_genhd_no);
//assert(__cil_tmp2 == fixed_request_queue[1].queue_lock);
//assert(__cil_tmp2 == fixed_request_queue[9].queue_lock);
//assert(action == fixed_request_queue[7].__ddv_queue_alive);
//assert(action == fixed_request_queue[9].hardsect_size);
assert(_ddv_module_param_action != _ddv_module_param_nowayout);
//assert(action == fixed_request_queue[0].backing_dev_info.state);
assert(action == nowayout);
//assert(action == fixed_request_queue[0].unplug_fn);
//assert(action == fixed_request_queue[2].__ddv_queue_alive);
//assert(__cil_tmp2 == fixed_request_queue[7].queuedata);
//assert(action == fixed_request_queue[3].make_request_fn);
//assert(action == fixed_request_queue[5].__ddv_queue_alive);
//assert(action == fixed_request_queue[0].__ddv_queue_alive);
//assert(action == fixed_request_queue[9].backing_dev_info.capabilities);
//assert(action == fixed_request_queue[5].unplug_fn);
//assert(action == fixed_request_queue[8].__ddv_genhd_no);
//assert(action == fixed_request_queue[2].backing_dev_info.capabilities);
//assert(__cil_tmp2 == fixed_request_queue[1].queuedata);
//assert(action == fixed_request_queue[0].__ddv_genhd_no);
//assert(action == fixed_request_queue[4].__ddv_genhd_no);
//assert(action == fixed_request_queue[6].backing_dev_info.capabilities);
//assert(action == fixed_request_queue[8].queue_flags);
//assert(action == fixed_request_queue[7].hardsect_size);
//assert(action == fixed_request_queue[4].unplug_fn);
assert(action == zf_expect_close);
assert(_ddv_module_description != _ddv_module_license);
assert(action == kernel_lock.locked);
assert(_ddv_module_description >= _ddv_module_license);
assert(_ddv_module_license <= _ddv_module_param_nowayout);
//assert(action == fixed_request_queue[1].__ddv_queue_alive);
assert(_ddv_module_author != _ddv_module_param_nowayout);
assert(current_execution_context == 1);
//assert(action == fixed_request_queue[9].__ddv_genhd_no);
//assert(action == fixed_request_queue[0].backing_dev_info.capabilities);
//assert(action == fixed_request_queue[9].unplug_fn);
//assert(action == fixed_request_queue[1].backing_dev_info.capabilities);
//assert(action == fixed_request_queue[7].backing_dev_info.capabilities);
assert(__cil_tmp2 == 0);
assert(__cil_tmp3 != 0);
//assert(__cil_tmp2 == fixed_request_queue[8].queuedata);
//assert(__cil_tmp2 == fixed_request_queue[7].queue_lock);
//assert(action == fixed_request_queue[5].make_request_fn);
assert(action == i);
//assert(action == fixed_request_queue[5].queue_flags);
assert(_ddv_module_author != _ddv_module_param_action);
//assert(__cil_tmp2 == fixed_request_queue[4].queue_lock);
assert(_ddv_module_description != _ddv_module_param_nowayout);
//assert(__cil_tmp2 == fixed_request_queue[5].queuedata);
//assert(action == fixed_request_queue[5].hardsect_size);
//assert(action == fixed_request_queue[3].backing_dev_info.state);
//assert(action == fixed_request_queue[1].hardsect_size);
//assert(action == fixed_request_queue[7].backing_dev_info.ra_pages);
//assert(action == fixed_request_queue[2].__ddv_genhd_no);
assert(_ddv_module_author <= _ddv_module_description);
//assert(action == fixed_request_queue[1].__ddv_genhd_no);
assert(_ddv_module_description <= _ddv_module_param_nowayout);
//assert(action == fixed_request_queue[7].queue_flags);
assert(_ddv_module_author <= _ddv_module_param_action);
    __cil_tmp3 = (void *)0;
//assert(action == fixed_request_queue[3].__ddv_queue_alive);
//assert(action == fixed_request_queue[6].backing_dev_info.ra_pages);
