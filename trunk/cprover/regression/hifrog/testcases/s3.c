...
SSL_METHOD *sslv3_base_method(void) { return (SSL_METHOD*) malloc(sizeof(SSL_METHOD)); }
...
//    SSL *s ;
  ...
  s->state = 12292;
  // XXX Modified AEJ
  s->ctx = (SSL_CTX*)malloc(sizeof(SSL_CTX));
  ssl3_connect(s);
  }
  return (0);
}
...
//  int *tmp___0 ;
  ...
  s->state = 12292;
assert(init == 1);
assert(blastFlag == skip);
assert(blastFlag == state);
assert(tmp___5 == 4195456);
assert(blastFlag == new_state);
assert(num1 == 140737351857952L);
assert(s != 0);
assert(blastFlag == ret);
assert(tmp___2 == 32767);
assert(tmp___2 == tmp___4);
assert(tmp___1 == -139866219);
assert(cb != 0);
assert(buf != 0);
assert(blastFlag == tmp);
assert(blastFlag == tmp___8);
assert(blastFlag == tmp___7);
assert(blastFlag == tmp___6);
assert(l == 360);
assert(tmp___3 == -9280);
assert(blastFlag == tmp___0);
assert(blastFlag == 0);
assert(tmp___9 == 140737488346048L);
  tmp = nondet_int();
assert(init == 1);
assert(blastFlag == skip);
assert(blastFlag == state);
